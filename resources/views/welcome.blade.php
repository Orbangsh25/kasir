...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ URL::asset('adminlte/index3.html');}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Pertanianku</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Kasirku</a>
        </div>
      </div>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>SEMANGAT ^.^</h1>
                <p>Kamu harus mengambil resiko, kamu harus menerima perubahan, maka hanya kamu yang akan memahami keajaiban hidup sepenuhnya.</p>
                <p>Jika kamu ingin dijamin sukses, lakukan segala upaya untuk menyenangkan Allah.</p>
                <p>Orang yang tak pernah membuat kesalahan, maka tak akan pernah mencoba sesuatu yang baru.</p>
                <p>Sesekali berhentilah untuk sekadar bersantai. Bukan untuk terlena, kemudian membangun semangat untuk perjuangan berikutnya.</p>
            </div>
          <div class="col-sm-6">
...
@yield('content')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 - <a href="">WhyAgstn</a>.</strong> All rights reserved.
  </footer>
